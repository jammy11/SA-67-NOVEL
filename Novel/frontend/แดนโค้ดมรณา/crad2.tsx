...
const Card2: React.FC<CardProps> = ({ card, showModal, handleCloseModal }) => {
      ...
      <Modal show={showUnlock} onHide={handleCloseUnlock}>
        <div className='modal-contentnew custom-modal'>
          ...
          <div className="text-heading">
            ...
            <div onClick={handleConfirmPurchase}>
      ...
      <Modal show={showConfirmation} onHide={handleCloseConfirmation}>
        <div className='modal-contentnew2 custom-modalnew'>
          <div className='confirmation-message'>
            ...
            <span className="text-1">
              <span id='ready2'>นิยายจะถูกนำไปไว้<br />ในชั้นหนังสือของคุณ</span>
            </span>
            <span id='buttonbook'>
